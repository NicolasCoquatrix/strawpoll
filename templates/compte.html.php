<div class="container py-4">
    ...
    <div class="row justify-content-center">
        ...
        <div class="mb-4 col-lg-6">
            ...
            <div id="passwordCardBox">
                <div class="mb-4 card" id="passwordCard">
                    <div class="gap-2 card-header d-flex justify-content-center">
...
<!-- TEMPLATE INFORMATIONS PERSONNELLES -->
<template id="infosTemplate">
    <div id="infosCard">
        <div class="card">
            <div class="gap-2 card-header d-flex justify-content-center">
                <i class="d-flex align-items-center fas fa-user-cog fa-icon-large"></i>
            ...
            <form method="POST" id="form" name="form">
                <div class="card-body">
                    ...
                    <div id="addressBox">
                        <div class="mb-2 d-flex gap-2">
                            <div class="px-3 py-0 mb-0 alert alert-success" id="addressSate"></div>
                            <i class="my-auto fas fa-map-marker-alt"></i>
                    ...
                    <div id="genderBox">
                        <div class="mb-2 d-flex gap-2">
                            <div class="px-3 py-0 mb-0 alert alert-success" id="genderSate"></div>
                            <i class="my-auto fas fa-venus-mars"></i>
                    ...
                    <div id="birthBox">
                        <div class="mb-2 d-flex gap-2">
                            <div class="px-3 py-0 mb-0 alert alert-success" id="birthSate"></div>
                            <i class="my-auto fas fa-calendar-alt"></i>
                ...
                <div class="card-footer d-flex justify-content-between gap-3">
                    ...
                    <!-- BOUTON ANNULER -->
                    <button type="button" class="btn btn-secondary w-100" id="formSubmit">
                        <i class="fas fa-times-circle"></i> Annuler
                    </button>

                    <!-- BOUTON ENVOYER -->
                    <button type="submit" class="btn btn-success w-100" name="form_submit" id="infosSubmit">
            ...
            <form method="POST" id="form" name="form">
                <div class="card-body">
                    ...
                    <div id="newPasswordBox">
                        ...
                        <div class="input-group mb-1">
                            <input type="password" class="form-control" name="oldPassword" id="newPassword" placeholder="Entrez votre nouveau mot de passe" minlength="8" maxlength="40" required>
                            <span class="p-0 input-group-text">
